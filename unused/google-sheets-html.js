...
var query = new google.visualization.Query('https://spreadsheets.google.com/tq?key=1QXPxTCsRQLL5yJZ3IdsUs4SWVX-CveCXdyJ7EkDPFuw&output=html&usp=sharing');
    query.setQuery('SELECT A, B, C, D label A "Duration", B "Song", C "Requested By", D "URL"');
    query.send(handleQueryResponse);
//1QXPxTCsRQLL5yJZ3IdsUs4SWVX-CveCXdyJ7EkDPFuw
